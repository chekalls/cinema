...
public class CGenericUtils {
    ...
    /**
     * Recherche d'entités par texte (ILIKE sur tous les champs String)
     */
        ...
        try {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query.toString())) {
                for (int i = 0; i < orderedCriteria.size(); i++) {
                    Object value = orderedCriteria.get(i).getValue();
                    if (value instanceof String) {
                        pstmt.setObject(i + 1, "%" + value + "%"); // LIKE avec wildcards
                    } else {
    ...
    public static <T extends BaseEntity> List<T> find(Connection connection, Class<T> clazz,
        ...
        try {
            ...
            try (PreparedStatement pstmt = connection.prepareStatement(query.toString())) {
                for (int i = 0; i < orderedCriteria.size(); i++) {
                    pstmt.setObject(i + 1, orderedCriteria.get(i).getValue());
                }
    ...
    public static <T extends BaseEntity> T save(Connection connection, T entity) {
        ...
        try {
            ...
            if (hasSingleAutoGeneratedId) {
                ...
                if (id == null) {
                    ...
                    try (var pstmt = connection.prepareStatement(updateSql)) {
                        ...
                        pstmt.setObject(paramIndex, ClassUtils.getClassIdValue(entity));
                        pstmt.executeUpdate();
                    }
                }
            } else {
            ...
            throw new RuntimeException("Error saving " + clazz.getSimpleName(), e);
        }
        return entity;
    }
    ...
    /**
     * Recherche paginée avec recherche textuelle (ILIKE sur champs String)
     */
