                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-control" id="cinemaId" name="cinemaId" required>
                                <option value="" disabled <c:if test="${salle == null || salle.cinemaId == null}">selected</c:if>>-- Sélectionnez un cinéma --</option>
                                <c:forEach var="cinema" items="${cinemas}">
                                    <option value="${cinema.id}" <c:if test="${salle != null && salle.cinemaId != null && cinema.id == salle.cinemaId}">selected</c:if>>${cinema.nom}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <small class="form-text text-muted">Choisissez le cinéma auquel appartient la salle.</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="numero" name="numero" value="${salle.numero}" placeholder="Ex: S01" required>
                        </div>
                        <small class="form-text text-muted">Identifiant interne de la salle (ex: S01, VIP1).</small>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="designation" name="designation" value="${salle.designation}" placeholder="Ex: Salle IMAX" required>
                        </div>
                        <small class="form-text text-muted">Nom lisible de la salle pour l'affichage public.</small>
                    </div>

                    <!-- Capacite -->
                    <div class="form-group">
                        <label for="capaciteTotal">Capacité totale <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-users"></i></span>
                            </div>
                            <input type="number" class="form-control" id="capaciteTotal" name="capaciteTotal" value="${salle.capaciteTotal}" min="1" placeholder="Ex: 150" required>
                        </div>
                        <small class="form-text text-muted">Nombre total de places assises.</small>
                    </div>
