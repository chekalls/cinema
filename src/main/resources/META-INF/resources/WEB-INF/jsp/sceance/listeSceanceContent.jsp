        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="/sceances/form" class="btn btn-primary btn-sm"><i class="fas fa-plus mr-1"></i> Nouvelle séance</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <form action="/sceances" method="get" class="form-inline">
                            <div class="input-group input-group-sm" style="width: 100%;">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <c:if test="${not empty search}">
                                        <a href="/sceances" class="btn btn-default"><i class="fas fa-times"></i></a>
                                    </c:if>
                                </div>
                            </div>
                        </form>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                        <c:if test="${empty sceances}">
                            <tr>
                                <td colspan="6" class="text-center text-muted">
                                    <i class="fas fa-inbox fa-3x mb-3"></i>
                                    <p>Aucune séance trouvée</p>
                                    <a href="/sceances/form" class="btn btn-primary btn-sm"><i class="fas fa-plus mr-1"></i> Ajouter une séance</a>
                                </td>
                            </tr>
                        </c:if>

                        <c:forEach var="sceance" items="${sceances}" varStatus="iterStat">
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="/sceances/edit/${sceance.id}" class="btn btn-info" title="Modifier"><i class="fas fa-edit"></i></a>
                                        <a href="/sceances/view/${sceance.id}" class="btn btn-primary" title="Voir détails"><i class="fas fa-eye"></i></a>
                                        <button type="button" class="btn btn-danger" data-id="${sceance.id}" data-film="${sceance.film != null ? sceance.film.titre : 'Séance'}" onclick="confirmDelete(this)" title="Supprimer"><i class="fas fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
                        ...
                        <c:if test="${totalPages > 1}">
                            <nav>
                                <ul class="pagination pagination-sm mb-0 justify-content-end">
                                    <c:url var="prevUrl" value="/sceances">
                                    ...
                                    <c:forEach var="i" begin="1" end="${totalPages}">
                                        <c:url var="pageUrl" value="/sceances">
                                    ...
                                    <c:url var="nextUrl" value="/sceances">
                                        <c:param name="page" value="${page + 1}" />
                                        <c:param name="size" value="${size}" />
                                        <c:param name="search" value="${search}" />
                                    </c:url>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Êtes-vous sûr de vouloir supprimer la séance <strong id="sceanceName"></strong> ?</p>
...
<script>
    function confirmDelete(button){
        ...
        $('#sceanceName').text(name);
        $('#deleteForm').attr('action', '/sceances/delete/' + id);
